...
pub const AWS_LC_AES_GCM_ENCRYPTION_FAILED: &str = "AWS-LC AES-GCM encryption failed";
pub const AWS_LC_AES_GCM_DECRYPTION_FAILED: &str = "AWS-LC AES-GCM decryption failed";
